...
app.put('/student/:id', async (req, res) => {
    ...
    try {
        const sql = 'UPDATE student SET name = ?, roll_number = ?, class = ? WHERE id = ?';
        await db.query(sql, [name, rollNo, studentClass, studentId]);
...
app.put('/teacher/:id', async (req, res) => {
    ...
    try {
        const sql = 'UPDATE teacher SET name = ?, subject = ?, class = ? WHERE id = ?';
        await db.query(sql, [name, subject, teacherClass, teacherId]);
